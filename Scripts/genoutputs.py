...
def genoutputs(gui_params, get_data_dict):
    ...
    Energy_All_End_Uses_dict = {
        ...
        "ASHP_Compressor_Heat_Elec[kWh]": ['DX_HEATING_COIL:Heating Coil Heating Energy [J](Annual)', "Elec"],
        ...
        "IntEquip_Clotheswasher_Elec[kWh]": ['clotheswasher:InteriorEquipment:Electricity [J](Annual)', "Elec"],
        "IntEquip_Dishwasher_Elec[kWh]": ['dishwasher:InteriorEquipment:Electricity [J](Annual)', "Elec"],
        "IntEquip_Refrigerator_Elec[kWh]": ['refrigerator:InteriorEquipment:Electricity [J](Annual)', "Elec"],
        ...
        "IntEquip_Misc_Gas[therm]": ['gas_mels:InteriorEquipment:NaturalGas [J](Annual)', "Gas"],
    ...
    Demand_Total_Electric_HVAC_dict = {
        "Total_Electric_HVAC[W]": ['Whole Building:Facility Total HVAC Electricity Demand Rate [W]' + '(' + gui_params["output_gran"] +')', "Elec"],
        "Living_Zone_Air_Temperature[F]": ['LIVING:Zone Mean Air Temperature [C]' + '(' + gui_params["output_gran"] +')', "Temp"],
        "Attic_Zone_Air_Temperature[F]": ['ATTIC:Zone Mean Air Temperature [C]' + '(' + gui_params["output_gran"] +')', "Temp"],
        "Crawlspace_Zone_Air_Temperature[F]": ['CRAWLSPACE:Zone Mean Air Temperature [C]' + '(' + gui_params["output_gran"] +')', "Temp"],
    }

    Demand_Heating_dict = {
        "ASHP_Compressor_Heat[W]": ['MAIN DX HEATING COIL_UNIT1:Heating Coil Electricity Rate [W]' + '(' + gui_params["output_gran"] +')', "Elec"],
    ...
    Demand_Cooling_dict = {
        "Cooling[W]": ['DX COOLING COIL_UNIT1:Cooling Coil Electricity Rate [W]' + '(' + gui_params["output_gran"] +')', "Elec"],
        "Living_Zone_Air_Temperature[F]": ['LIVING_UNIT1:Zone Mean Air Temperature [C]' + '(' + gui_params["output_gran"] +')', "Temp"],
        "Attic_Zone_Air_Temperature[F]": ['ATTIC_UNIT1:Zone Mean Air Temperature [C]' + '(' + gui_params["output_gran"] +')', "Temp"],
        "Crawlspace_Zone_Air_Temperature[F]": ['CRAWLSPACE_UNIT1:Zone Mean Air Temperature [C]' + '(' + gui_params["output_gran"] +')', "Temp"],
    }
    ...
    Demand_Fan_dict = {
        "Main_Supply_Fan[W]": ['SUPPLY FAN_UNIT1:Fan Electricity Rate [W]' + '(' + gui_params["output_gran"] +')', "Elec"],
    ...
    Demand_Water_Heating_dict = {
        "Electric_Water_Heater[W]": ['WATER HEATER_UNIT1:Water Heater Electricity Rate [W]' + '(' + gui_params["output_gran"] +')', "Elec"],
    ...
    Demand_Other_Electric_Equipment_dict = {
