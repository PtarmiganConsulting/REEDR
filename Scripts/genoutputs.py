...
def genoutputs(gui_params, get_data_dict):
    ...
    "Heat_Elec[kWh]": ['Heating:Electricity [J](Annual)', "Elec"],
    ...
    "IntEquip_Elec[kWh]": ['InteriorEquipment:Electricity [J](Annual)', "Elec"],
    "HeatRecov_Elec[kWh]": ['HeatRecovery:Electricity [J](Annual)', "Elec"],
    "Total_Gas[therm]": ['NaturalGas:Facility [J](Annual)', "Gas"],
    "Heating_Gas[therm]": ['Heating:NaturalGas [J](Annual)', "Gas"],
    "DHW_Gas[therm]": ['WaterSystems:NaturalGas [J](Annual)', "Gas"],
    "IntEquip_Gas[therm]": ['InteriorEquipment:NaturalGas [J](Annual)', "Gas"],
    ...
    "Infiltration_Living[ACH]": ['LIVING_UNIT1:AFN Zone Infiltration Air Change Rate [ach](Annual)', "NA"],
    "Infiltration_Attic[ACH]": ['ATTIC_UNIT1:AFN Zone Infiltration Air Change Rate [ach](Annual)', "NA"],
    "Infiltration_Crawlspace[ACH]": ['CRAWLSPACE_UNIT1:AFN Zone Infiltration Air Change Rate [ach](Annual)', "NA"],
    ...
    report_name = output_type + "_" + output_enduses
    #... determine which output dictionary to use for report, defined as a string
    output_dict_str = output_type + "_" + output_enduses + "_dict"
