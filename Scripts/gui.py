...
def gui(func):
    ...
    # Copyright label
    ttk.Label(frm, text="Copyright (C) 2024 Ptarmigan Consulting LLC. All rights reserved.", style='Copyright.TLabel').grid(sticky=W, column=0, row=16, padx=10, columnspan=5)
