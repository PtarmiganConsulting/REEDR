...
- **_Model Input File_**: This is a drop-down menu where users can select which "Model Input Template" they would like to run for a particular analysis. Before v1.3.0, this file had to be named "Model Input Template"; however, starting in v1.3.0, users can now make copies of "Model Input Template" and rename them, allowing for more flexible analysis.
